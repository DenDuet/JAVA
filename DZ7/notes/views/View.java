    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                ...
                logger.log("- Введега неправильная команда. ");
                continue;
            }
            ...
            try {
                switch (com) {
                    case CREATE:
                        ...
                        logger.log("- Выбран пункт создание заметки. ");
                        controller.saveNote(note);
                        logger.log("- Ок. ");
                        break;
                    case READ:
                        String id = prompt("Номер заметки: ", false);
                        logger.log("- Выбран пункт чтение заметки по Id: " + id);
                    ...
                    case LIST:
                        ...
                        logger.log("- Выбран пункт отображения всех заметок. ");
                        ...
                        break;
                    case UPDATE:
                        logger.log("- Выбран пункт обновления заметки. ");
                    ...
                    case DELETE:
                        ...
                        logger.log("- Выбран пункт удаления заметки по Id: " + noteId);
